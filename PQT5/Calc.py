...
class calculator(QWidget):
    ...
    def initUI(self):
        ...
        self.nacelo = QPushButton("//", self)
        self.nacelo.resize(50, 50)
        self.nacelo.move(225, 100)

        self.ost = QPushButton("%", self)
        self.ost.resize(50, 50)
        self.ost.move(225, 155)

        self.stepen = QPushButton("^2", self)
        self.stepen.resize(50, 50)
        self.stepen.move(225, 210)
